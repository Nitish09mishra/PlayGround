...
import de.hybris.training.service.impl.DefaultDemoExtensionService;
 ...
 */
@IntegrationTest
public class DefaultDemoExtensionServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "demoExtensionPlatformLogo";

		// when
		final String logoUrl = demoExtensionService.getHybrisLogoUrl(logoCode);
