...
public class DefaultDemoExtensionService implements DemoExtensionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultDemoExtensionService.class);
	...
	{
		return DefaultDemoExtensionService.class.getResourceAsStream("/demoExtension/sap-hybris-platform.png");
	}
